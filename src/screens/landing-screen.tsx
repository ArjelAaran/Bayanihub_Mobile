            ...
            <View style={styles.navbarWrapper}>
              <View style={styles.navbarContainer}>
                ...
                <View style={styles.navLinks}>
                  <TouchableOpacity><Text style={styles.navLinkText}>Home</Text></TouchableOpacity>
                  <TouchableOpacity><Text style={styles.navLinkText}>About Us</Text></TouchableOpacity>
                  <View style={styles.authPill}>
                    <TouchableOpacity onPress={() => router.push("/signup")}><Text style={styles.authPillText}>Sign Up</Text></TouchableOpacity>
                    <View style={styles.authDivider} />
                    <TouchableOpacity onPress={() => router.push("/login")}><Text style={styles.authPillText}>Login</Text></TouchableOpacity>
                  </View>
                </View>
              </View>
            </View>
            ...
            <View style={styles.contentSection}>
              ...
              <View style={styles.buttonContainer}>
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {}}
                >
                  <Text style={styles.secondaryButtonText}>Report an Incident</Text>
                </TouchableOpacity>
              </View>
            </View>
